...
[String]$ClassPath = Join-Path -Path $PSScriptRoot -ChildPath 'Classes'
#All class files exported to the shell.
Get-ChildItem -Path $ClassPath -Filter "*.ps1" -Recurse | ForEach-Object -Process {
    Write-Verbose -Message "Importing $($_.BaseName)"
    . $_.FullName | Out-Null
}